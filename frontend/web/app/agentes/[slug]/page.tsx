        ...
        <div className="mx-auto max-w-6xl px-6 py-8">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:mt-0 sm:flex-shrink-0">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#E10600] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#B80500]"
            >
              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {agent.phone && (
              <a
                href={`tel:${agent.phone.replace(/\s/g, "")}`}
                className="inline-flex items-center justify-center gap-2 rounded-lg border border-[#E10600] px-6 py-3 text-sm font-semibold text-[#E10600] transition hover:bg-[#E10600]/10"
              >
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {agent.whatsapp && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#25D366] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#20BD5A]"
              >
